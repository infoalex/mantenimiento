...
class SolicitudCartaController extends BackendController {
    /**
    ...
    public function listar($order='order.nombre.asc', $page='pag.1') { 
        ...
        $this->order = $order;        
        $this->page_title = 'Listado de Solicitudes de Carta Aval';
    }
    ...
    public function registro($order='order.nombre.asc', $page='pag.1') { 
        ...
        $this->page_title = 'Registro de Solicitudes de Carta Aval';
    }
    /**
    ...
    public function aprobacion($order='order.nombre.asc', $page='pag.1') { 
        	...
        	$this->order = $order;        
        	$this->page_title = 'Aprobación de Solicitudes de Carta Aval';
    }
    /**
    ...
    public function contabilizar($order='order.nombre.asc', $page='pag.1') { 
        ...
        $this->order = $order;        
        $this->page_title = 'Contabilizar Solicitudes de Carta Aval';
    }
    /**
     * Método para agregar
     */
    public function agregar() {
       ...
       // $this->personas = Load::model('beneficiarios/titular')->getTitularesToJson();
        $this->page_title = 'Agregar Solicitudes de Carta Aval';
    }
    /**
